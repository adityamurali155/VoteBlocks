...
var transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: 'voteblocks.blockchain@gmail.com',
    pass: 'hmgonyudaisbdljl'
  },
  tls: {
...
router.post('/registerdata', function (req, res) {
  ...
  let sql = "SELECT * FROM user_registration WHERE aadharno = ?";
  conn.query(sql, data, (error, results, fields) => {
    ...
    if (is_registerd != 'YES') {
      if (age >= 18) {
        var mailOptions = {
          from: 'voteblocks.blockchain@gmail.com',
          to: email,
          subject: "Please confirm your Email account",
          text: "Hello, your registration OTP is: " + rand
        };
